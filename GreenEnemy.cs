...
public partial class GreenEnemy : CharacterBody2D
{
	...
	public override void _PhysicsProcess(double delta)
	{
		...
		floorDetector.TargetPosition = new Vector2(14 * direction, 21); //Esto mueve el rayo de deteccion a la direccion 25, 25 0 -25, 25 con respecto al personaje
